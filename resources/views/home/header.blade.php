                        ...
                        @auth
                         ...
                         @else 
                            ...
                            <li class="nav-item">
                                ...
                                <a href="{{ route('login') }}" id="logincss" class="nav-link btn btn-success"
                                    href="contact.html">Login</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('register') }}" id="logincss" class="nav-link btn btn-primary"
                                    href="contact.html">Register</a>
                            </li>
