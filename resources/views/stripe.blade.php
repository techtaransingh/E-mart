        ...
        <div class="mt-3">
            ...
            <div class="card mt-3">
                <div class="card-body">
                    ...
                    <p>Test card available here: <a href="https://stripe.com/docs/testing#cards"
                            target="_blank">Link</a></p>
                    <p>Payment method request docs: <a href="https://stripe.com/docs/api/payment_methods/create"
                            target="_blank">Link</a></p>
                    <p>Payment intent request docs: <a href="https://stripe.com/docs/api/payment_intents/create"
                            target="_blank">Link</a></p>
                </div>
            </div>
        </div>
